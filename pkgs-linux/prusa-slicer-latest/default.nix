{ stdenv, lib, openexr, jemalloc, c-blosc, binutils, fetchFromGitHub, cmake
...
, opencascade-occt, openvdb, pcre, qhull, tbb_2021_8, wxGTK32, xorg, fetchpatch
...
in stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    owner = "prusa3d";
    repo = "PrusaSlicer";
    sha256 = "sha256-Z80hj4GNj2a8VSNWsgqbrzMs5EI11Q/xhGVj4PPuVV8=";
